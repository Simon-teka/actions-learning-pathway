...
if direction.upper() == "LEFT":
    print("You chose go left. As you walk, you find a small house in the woods.")
    next_step = input("Do you want to KNOCK on the door or WALK around the house? ")
    
    if next_step.upper() == "KNOCK":
        print("You knock on the door and it creaks open. A friendly old man greets you.")
    ...
    print("You chose to go to the right. As you walk, you encounter a bridge in the distance.")
